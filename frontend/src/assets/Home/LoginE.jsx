...
import { clearErrors, logine } from "../../action/StudentAction";
...
const LoginE = () => {
  ...
  const Login = (e) => {
    e.preventDefault();
    dispatch(logine(phoneNumber, password));
  };
            ...
            <div className="signin-signup">
              <form onSubmit={Login} className="sign-in-form">
                ...
                <div className="signup_link">
                  Not a Member ?
                  <Link to="/register">
                    <span className=" text-red-500 ml-5 text-3xl underline">
                      Register
                    </span>
                  </Link>
                </div>
          ...
          <div className="panels-container">
            <div className="panel left-panel">
              <div className="content">
                ...
                <button
                  className="btn transparent hover:bg-orange-300"
                  id="sign-up-btn"
                >
